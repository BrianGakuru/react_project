...
//holds all projects to be in Project cards
        ...
        <section className="scroll-mt-24 min-h-screen py-20 px-4 text-center bg-white dark:bg-gray-900 dark:text-white">
            ...
            <div className="flex flex-wrap gap-3 justify-center mb-12">
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-full border border-blue-500 text-sm font-medium text-blue-500 hover:bg-blue-500 hover:text-white`}
                >
                    {type}
                </button>
                )}
