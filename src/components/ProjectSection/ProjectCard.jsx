const ProjectCard =({project}) =>{
    ...
    return(
        <div 
            onClick={handleClick}
            className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-md border dark:border-gray-700 cursor-pointer transform transition hover:shadow-xl hover:scale-105"
        >
